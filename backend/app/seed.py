...
async def seed_all() -> None:
    ...
    home_defaults = {
        ...
        "about_ar": "مركز لزام للدراسات القانونية مركز بحثي سعودي يُعنى بتطوير البحث القانوني الرصين، وإنتاج دراسات وتحليلات قانونية ذات صلة بالسياسات العامة والحوكمة والممارسة المؤسسية، بما يخدم احتياجات القطاعين العام والخاص، ويسهم في إثراء المعرفة القانونية في المملكة العربية السعودية.",
        ...
        "about_extended_ar": "ينطلق مركز لزام من الإيمان بأن البحث القانوني الموثوق يتطلب استقلالًا فكريًا، ومنهجية صارمة، وفهمًا دقيقًا للسياقات النظامية والمؤسسية.",
        ...
        "mission_ar": "تتمثل رسالة مركز لزام في الارتقاء بالبحث القانوني في المملكة العربية السعودية من خلال إنتاج دراسات قانونية رصينة وأصيلة وذات صلة بالسياسات العامة.",
        ...
        "mission_points_ar": [
            ...
            "تقديم مخرجات بحثية واستشارية قائمة على التحليل الرصين.",
            "ترسيخ ثقافة بحثية تقوم على المنهجية الصارمة والاستقلال الفكري.",
        ],
        "mission_points_en": [
            ...
            "Establish a research culture grounded in methodological rigour and intellectual independence.",
        ],
        "vision_ar": "تتمثل رؤية مركز لزام في أن يكون مؤسسة بحثية قانونية رائدة في المملكة العربية السعودية.",
        ...
        "vision_points_ar": [
            ...
            "المساهمة في الحوارات الإقليمية والعالمية حول القانون والحوكمة والإصلاح القانوني.",
            "إعداد جيل جديد من الباحثين القانونيين السعوديين.",
            "تقديم نموذج بحثي واستشاري قانوني قائم على المنهجية السليمة والمعاصرة.",
        ],
        "vision_points_en": [
        ...
        "objectives": [
            ...
            for i, o in enumerate([
                ...
                {"title_ar": "دعم حوكمة القطاع العام", "title_en": "Supporting Public Sector Governance",
                 "description_ar": "تقديم تحليلات قائمة على البحث للمؤسسات العامة في قضايا التشريع والتنظيم والصلاحيات المؤسسية.",
