    ...
    <PublicLayout>
      ...
      {visible.includes("hero") && (
        <section
          ...
          style={{ minHeight: "62vh", background: sectionBg("hero") || "var(--tb-navy-900, #0A111C)", color: "var(--tb-paper-base, #FBFAF7)" }}
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-end pb-16 md:pb-20 mx-auto w-full max-w-[1200px] px-6 md:px-10 lg:px-14">
            {t("hero_eyebrow_ar", "hero_eyebrow_en") && (
              <div className="flex items-center gap-3">
                ...
                <span style={{ color: "var(--tb-gold, #B08C5A)", letterSpacing: "0.22em", fontSize: 11 }} className="uppercase">
                  {t("hero_eyebrow_ar", "hero_eyebrow_en", "مجتمع البحث", "Research Community")}
                </span>
              </div>
            )}
            <h1 className="tb-display mt-4 max-w-[22ch]"
